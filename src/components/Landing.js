                ...
                <div className='partner_carousel container mt-5'>
                    <div className='container d-flex flex-wrap justify-content-around border-white'>
                        <div className="game__head">
                            ...
                            <div className="game__title">
                                <p className="game__name">
                                    BNB<span className='tiny_letter_minus'>+0.05%</span>
                                </p>
                                <span className="game__blockchain">
                                    0.36$
                                </span>
                        ...
                        <div className="game__head">
                            ...
                            <div className="game__title">
                                <p className="game__name">
                                    BTC<span className='tiny_letter_plus'>+0.05%</span>
                                </p>
                                <span className="game__blockchain">
                                    145$
                                </span>
                        ...
                        <div className="game__head">
                            ...
                            <div className="game__title">
                                <p className="game__name">
                                    ETH<span className='tiny_letter_plus'>+0.05%</span>
                                </p>
                                <span className="game__blockchain">
                                    1.56$
                                </span>
                        ...
                        <div className="game__head">
                            ...
                            <div className="game__title">
                                <p className="game__name">
                                    SOL<span className='tiny_letter_minus'>+0.05%</span>
                                </p>
                        ...
                        <div className="game__head">
                            ...
                            <div className="game__title">
                                <p className="game__name">
                                    DOT<span className='tiny_letter_plus'>+0.05%</span>
                                </p>
                                <span className="game__blockchain">
                                    5.67$
                                </span>
                    ...
                    {global.lan===false ? <h2>CTHULHU Partners</h2>
                        : <h2>CTHULHU Партнеры</h2> }
                    <Carousel
                        swipeable={false}
                        draggable={false}
                        showDots={false}
                        ...
                        <a href='https://exobotsgame.com/' target='_blank'>
                            <div className='image-container'>
